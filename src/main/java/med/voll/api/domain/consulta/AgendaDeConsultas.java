...
import med.voll.api.domain.validacoes.agendamento.ValidadorAgendamentoDeConsultas;
...
public class AgendaDeConsultas {
    ...
    public DadosDetalhamentoConsulta agendar(DadosAgendamentoConsulta dados){
        if(!pacienteRepository.existsById(dados.idPaciente())){
            throw new ValidacaoException("Id do paciente informado não exisite");
        }
    ...
    public void cancelar(DadosCancelamentoConsulta dados){
        ...
        validadoresCancelamento.forEach(validacao -> validacao.validar(dados));
